...
function Experience({ setProjectHover }) {
  ...
  return (
    ...
    >
      ...
      <div className="card-section" style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', marginTop: '0.5rem' }}>
        <h3 className="card-subtitle" style={{ color: '#888' }}>Projects</h3>
